  ...
  template: `
    <div class="fooddetail">
      ...
      <div class="content trace-content">
        ...
        <div>
          <span>生产时间</span>
          <span>{{ dateTime(food.timestamp) }}</span>
        </div>
      </div>
    </div>
  `,
...
const AddVegetable = {
  ...
  template:`
    <div>
      <el-dialog title="添加食品信息" :visible.sync="dialogFormVisible" :show-close="false" width="50%" :center="true">
  ...
  template: `
    <div>
      ...
      <el-table
        ...
        <!-- 鼠标点击食品细节弹窗信息 -->
        <el-popover trigger="click" placement="top" @show="handlePopover(scope.row)" :width="500">
